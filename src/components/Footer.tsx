...
export default function Footer() {
  ...
  return (
    <footer className="w-full border-t border-border-light">
      <div className="w-full max-w-frame mx-auto px-nav-x h-16 flex items-center justify-between max-md:h-auto max-md:py-4 max-md:flex-col max-md:items-start max-md:gap-2">
