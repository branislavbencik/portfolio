      ...
      <div className="pt-32 max-md:pt-16 pb-10 flex flex-col gap-6">
        <div className="animate-hero-content-in flex flex-col gap-6">
          ...
          <p className="type-lede text-text-primary max-w-lede">
            ...
            <CitationLink label="Service design" href="https://www.figma.com/board/u3gtseQ4wvLMcpNUy4UWWP/Teatime-procesy?node-id=2034-7737" external cursorLabel="End-to-end service design for a language school" />, through shipping the automations
            ...
            <CitationLink label="Schneider" href="https://www.figma.com/proto/YqwEFpw4xULPZhkk8G71rp/Schneider-Electric-%7C-Design-Sprint-Prototype?node-id=28343-3731&p=f&t=Au2ICcuaAsHIp6ET-1&scaling=min-zoom&content-scaling=fixed&page-id=28260%3A4&starting-point-node-id=28343%3A3731&show-proto-sidebar=1" external cursorLabel="Built in a 1-day Design Sprint" />, and code
            <CitationLink label="Sideproject" href="https://reprio.vercel.app/" external cursorLabel="Chat with AI to prioritize your tasks" />. Sometimes I go all the way down the rabbit hole to map states
            <CitationLink label="Skoala" href="https://www.figma.com/design/ElwxrYVb8YgqCfU1P6aIWE/Skoala-%7C-Teacher-Platform-Beta--Copy-?node-id=15633-97847&t=eetrjMXtBwq4OG2Q-1" external cursorLabel="Slides as parametrized CMS components" /> and exceptions.
          </p>
        </div>
      </div>
    </section>
