      ...
      <div className="pt-32 max-md:pt-16 pb-10 flex flex-col gap-6">
        <div className="animate-hero-content-in flex flex-col gap-6">
          ...
          <p className="type-lede text-text-primary max-w-lede">
            ...
            <CitationLink label="PRD" href="https://clever-statistic-860.notion.site/PRD-Personalized-English-Learning-System-34ee84d8cf3f808cbff3d01f55d39e49?pvs=73" external cursorLabel="Personalized English learning that proves HR ROI" />, through shipping the automations
