      ...
      <div className="pt-20 max-md:pt-10 pb-10 flex flex-col gap-6">
        <div className="animate-hero-content-in flex flex-col gap-6">
          <p className="type-hero-prose">
            ...
            <CitationLink label="Sideproject" href="https://reprio.vercel.app/" external /> — and down the rabbit hole
            <br className="max-md:hidden" />
            to the mapping of states<CitationLink label="Skoala" href="https://www.figma.com/design/ElwxrYVb8YgqCfU1P6aIWE/Skoala-%7C-Teacher-Platform-Beta--Copy-?node-id=15633-97847&t=eetrjMXtBwq4OG2Q-1" external /> and exceptions.
          </p>
        </div>
      </div>
    </section>
