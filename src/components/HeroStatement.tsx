      ...
      <div className="pt-20 max-md:pt-10 pb-10 flex flex-col gap-6">
        <div className="animate-hero-content-in flex flex-col gap-6">
          <p className="type-hero-prose">
            ...
            <CitationLink label="PRD" href="https://clever-statistic-860.notion.site/PRD-Personalized-English-Learning-System-34ee84d8cf3f808cbff3d01f55d39e49?pvs=73" external />, through shipping the automations
            ...
            <CitationLink label="Reprio" href="https://reprio.vercel.app/" external />. Sometimes I go all the way down the rabbit hole to map states
